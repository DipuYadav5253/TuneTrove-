                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                            String key = childSnapshot.getKey();
                             if(eId.equals(key)){
                                 Toast.makeText(ArtistEventCreation.this, "User With This Username Already Exist!!", Toast.LENGTH_SHORT).show();
                                  Intent i = new Intent(ArtistEventCreation.this, ArtistEventCreation.class);
                                  startActivity(i);
                                  contain = true;
                                 return;
                             }
